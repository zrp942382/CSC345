...
unitTests = testGroup "Unit tests" [
        ...
        testGroup "test_value2" [
            ...
            testCase "test_C1" $ assertEqual [] (Just (-23)) (value2 (Sub2 (Mul2 (Val2 (-10)) (Val2 2)) (Div2 (Val2 (17)) (Val2 5)))),
            testCase "test_C2" $ assertEqual [] (Just 3) (value2 (Div2 (Mul2 (Sub2 (Add2 (Val2 (-10)) (Val2 (8))) (Val2 (-17))) (Val2 4)) (Val2 20))),
            testCase "test_C3" $ assertEqual [] Nothing (value2 (Sub2 (Add2 (Val2 (-10)) (Val2 2)) (Div2 (Val2 (17)) (Val2 0)))),
            testCase "test_C4" $ assertEqual [] Nothing (value2 (Div2 (Mul2 (Val2 7) (Val2 3)) (Sub2 (Val2 (4)) (Add2 (Val2 1) (Val2 3))))),
            ...
            testCase "test_C7" $ assertEqual [] Nothing (value2 (Mul2 (Add2 (Val2 (-10)) (Val2 2)) (Div2 (Val2 (17)) (Val2 0))))
        ...
        testGroup "test_show" [
            ...
            testCase "test_B6" $ assertEqual [] "1000 / 4 * 17 - 50" (show (Mul2 (Div2 (Val2 (1000)) (Val2 4)) (Sub2 (Val2 (17)) (Val2 50)))),
            testCase "test_B7" $ assertEqual [] "10 * 4 + -17 / 0" (show (Add2 (Mul2 (Val2 (10)) (Val2 4)) (Div2 (Val2 (-17)) (Val2 0))))
        ],
