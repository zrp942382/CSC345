...
unitTests = testGroup "Unit tests" [
        ...
        testGroup "test_filterFirst" [
            ...
            testCase "test8" $ assertEqual [] [1,3,4] (filterFirst (\x -> x >= 2) [1,2,3,4]),
            testCase "test9" $ assertEqual [] [1,3,1] (filterFirst (\x -> x >= 2) [1,2,3,1]),
            testCase "test10" $ assertEqual [] [2,1] (filterFirst (\x -> x == 3) [3,2,1]),
            testCase "test11" $ assertEqual [] [2,3] (filterFirst (\x -> x == 1) [2,3,1]),
            testCase "test12" $ assertEqual [] [1,1] (filterFirst (\x -> x == 1) [1,1,1]),
            testCase "test13" $ assertEqual [] [5,8] (filterFirst (\x -> x > 0) [10,5,8]),
        ...
        testGroup "test_filterLast" [
            ...
            testCase "test7" $ assertEqual [] [1] (filterLast (\x -> x >= 2) [1,4]),
            testCase "test8" $ assertEqual [] [1,2,3] (filterLast (\x -> x >= 2) [1,2,3,4]),
            testCase "test9" $ assertEqual [] [1,2,1] (filterLast (\x -> x >= 2) [1,2,3,1]),
            testCase "test10" $ assertEqual [] [2,1] (filterLast (\x -> x == 3) [3,2,1]),
            testCase "test11" $ assertEqual [] [2,3] (filterLast (\x -> x == 1) [2,3,1]),
            testCase "test12" $ assertEqual [] [1,1] (filterLast (\x -> x == 1) [1,1,1]),
            testCase "test13" $ assertEqual [] [10,5] (filterLast (\x -> x > 0) [10,5,8]),
